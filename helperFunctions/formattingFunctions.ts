import { Response } from "../typesInterfaces";
 ...
 */
export function formatDatePostgresql(date: Date): string {
 ...
 */
export function formatResponsesPostgresql(responses: Response[]): string {
  let output = "{"
